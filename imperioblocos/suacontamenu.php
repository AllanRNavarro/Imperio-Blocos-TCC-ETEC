...
<link rel="shortcut icon" href="img/logorodape.png" />
 ...
 <script type="text/javascript" src="bootstrap-4.3.1-dist/js/jquery.js"></script>
  ...
  <?php	
		...
		{
			$select = $con->prepare("SELECT * tb_ususario where nm_usuario ='". $_SESSION['cd_usuario']."'");
			$select->execute();
			$row = $select->fetch();
		}*/
	?>
            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-left mr-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  ...
                  <li  class="active"><a href="suacontamenu.php" class="nav-link">Sua conta</a></li>
...
<div class="cadastro">
	...
	<h1 style="text-align:center;">Consulte sua conta</h1>
...
<?php  
	...
	try 
	{
		...
		$select = $con->prepare("SELECT * FROM tb_usuario where cd_usuario ='".$_SESSION['cd_usuario']."'");
		$select->execute();
		...
		while($row = $select->fetch()) 
		{
			...
			echo "</p>";
?>
		<input type="button" name="Alterar" value="Complete ou altere seus dados" class="buttonAlterar" onclick="javascript: location.href='alterarsuacontamenu.php?codigo=<?php echo $row['cd_usuario']; ?>'" />
				
		<input type="button" name="Voltar" value="Voltar" 	class="botaoVoltar" onclick="javascript: location.href='menu.php'">
