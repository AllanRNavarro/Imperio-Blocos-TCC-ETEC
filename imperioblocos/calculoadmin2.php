...
<!-- Google font -->
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <header class="site-navbar site-navbar-target bg-white" role="banner">
	  ...
	  <center>
	  		<form action="calculoadmin2.php" method="POST">
	...
	echo "<br><br>";
	echo "<div class='col-sm-6'> <input type='text' style='font-size:30px;color:black; font-family: 'PT Sans'', sans-serif; placeholder='". (((($v1 * $v2)*(12.5))+ 10/100*(($v1 * $v2)*(12.5)))-($v3*$v4)-($v5*$v6))." &nbsp;blocos' readonly> </div>";
