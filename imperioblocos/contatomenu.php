          ...
          <div class="row align-items-center position-relative">
            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-left mr-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  <li  class="active"><a href="contatomenu.php" class="nav-link">Contato</a></li>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5" >
            <form action="#" method="post">
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                <div class="col-md-12">
                  <textarea name="" id="" class="form-control" placeholder="Escreva sua mensagem" cols="30" rows="13"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5 rounded-0" value="Enviar mensagem">
                </div>
              </div>
            </form>
          </div>
          <div class="col-lg-4 ml-auto">
            <div class="bg-white p-3 p-md-5">
              <h3 class="heading-39291">Informações de contato</h3>
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  <span class="d-block text-black small text-uppercase font-weight-bold">Endereço</span>
                  <span>Rua Francisco Antonio de Abreu,nº65-Jardim Real,Praia Grande-SP</span></li>
                <li class="d-block mb-3"><span class="d-block text-black small text-uppercase font-weight-bold">Número:</span><span>(13) 99123-1417</span></li>
                <li class="d-block mb-3"><span class="d-block text-black small text-uppercase font-weight-bold">E-mail:</span><span>imperioblocos@gmail.com</span></li>
				 <li class="d-block mb-3"><span class="d-block text-black small text-uppercase font-weight-bold">Horário de funcionamento</span><span>Seg/Ter/Qua/Qui/Sex/Sáb <br> 07:00 – 17:30 <br> Dom: Fechado </span></li>
