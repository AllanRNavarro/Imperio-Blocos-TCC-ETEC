            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-right ml-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
				  ...
				  <li class="active"><a href="sobreadmin.php" class="nav-link">Sobre</a></li>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-5">
            <h2 class="heading-39291">HISTÓRIA DA EMPERIO BLOCOS</h2>
            <p class="mb-5">Uma empresa que começou a partir do passe o ponto, por conta de dívidas e da má fama, hoje se tornou uma fábrica de blocos, que mesmo com pouco tempo de história, satisfaz seus clientes, dos fixos aos corriqueiros.</p>
          ...
          <div class="col-md-6 ml-auto">
            <img src="img/BANNER HISTORIA.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 bg-white text-center">
              <a href="#" class="d-inline-block">
                <img src="img/missão-1.png" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
               
                <h1>Missão</h1>
                <p>Contribuir para crescimento e evolução no ramo da construção civil das cidades da baixada santista.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 bg-white text-center">
              <a href="#" class="d-inline-block">
                <img src="img/visão-2.png" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
               
                <h1>Visão</h1>
                <p>Ser reconhecido na área da construção civil pela qualidade, agilidade e preços acessíveis aos consumidores.</p>
              </div>
            </div>
          </div> 
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 bg-white text-center">
              <a href="#" class="d-inline-block">
                <img src="img/valores-3.png" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
              
                <h1>Valores</h1>
                <p>Comprometimento com clientes, responsabilidade ambiental, engajamento profissional, excelência na fabricação de seus produtos.</p>
              </div>
            </div>
          </div>
