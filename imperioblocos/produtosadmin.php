            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-right ml-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  ...
                  <li class="active"><a href="produtosadmin.php" class="nav-link">Produtos</a></li>
                </ul>
              </nav>
            </div>
           ...
           <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="service-291934 text-center " >
			  ...
			  <p>Variedades de tamanhos e expessuras entre os blocos cerâmicos e os blocos de concreto.</p>
			    <h3 class="mb-4"><a href="calculadoraadmin.php"  onclick="Alert.render('Alert Modificado')">calcular</a></h3>
